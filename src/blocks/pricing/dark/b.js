        ...
        <section className="text-gray-500 bg-gray-900 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto flex flex-wrap">
                <div className="lg:w-1/4 mt-48 hidden lg:block">
                    <div
                        className="mt-px border-t border-gray-700 border-b border-l rounded-tl-lg rounded-bl-lg overflow-hidden">
              ...
              <span
                ...
                >
                  <path d="M20 6L9 17l-5-5"/>
                    ...
                    <div
                        className="lg:w-1/3 w-full lg:mt-px border-2 border-gray-700 lg:border-none rounded-lg lg:rounded-none">
                        <div className="px-2 text-center h-48 flex flex-col items-center justify-center">
